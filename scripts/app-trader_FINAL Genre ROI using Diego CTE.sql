...
SELECT 
	...
	--, price_play::money
FROM top_100
GROUP BY genre--, profit, buy_cost, marketing_cost, rev_count_app, rev_count_play--, price_app, price_play
ORDER BY count desc, avg_profit desc


/*
-- Code to look at full table, by app, for top 100
SELECT *
	FROM top_100;
*/
