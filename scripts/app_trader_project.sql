--getting top 10 apps from both stores ordered by net profit
SELECT *,(profit_before_marketing_cost -  highest_lifespan_months*1000)::MONEY AS both_profit_after_marketing_cost
FROM ( SELECT  *,
